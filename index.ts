...
const {user, password, db} = require('./server/database/connection/dev') //dev connection
...
const app = express()
app.use(express.json(), cookieParser(), cors({credentials: true, origin:
        ['https://drew24n.github.io', 'http://localhost:3000']}))
